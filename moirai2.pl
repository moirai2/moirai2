...
getopts('a:b:c:C:d:D:E:f:F:g:G:hHi:lm:o:O:pq:Q:r:s:S:uw:x');
############################## HELP ##############################
sub help{
	print "\n";
	print "############################## HELP ##############################\n";
	...
	print "         -c  Use (c)ontainer image for execution [docker|singularity .sif|openstack].\n";
	print "         -C  (C)onfiguration of openstack/aws instance like .\n";
